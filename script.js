...
const projectData = {
  klimaspor: {
    title: 'Klimaspor - CO2 Emissions Screening Tool',
    image: 'images/klimaspor_dashboard.jpg',
    tags: ['Next.js 14', 'TypeScript', 'React 18', 'Tailwind CSS', 'e-conomic API'],
    description: 'A screening tool that calculates CO2 emission reports for Danish companies based on their e-conomic accounting data. The tool provides greenhouse gas emission estimates using statistical averages and recognized emission factors according to the GHG Protocol.',
    features: [
      'Automated CO2 emission screening from accounting data',
      'Integration with e-conomic bookkeeping system',
      'GHG Protocol Corporate Standard methodology',
      'Spend-based method for Scope 3 emissions',
      'Emission factors from DEFRA, IEA, and IPCC',
      'Categorization in Scope 1, 2, and 3 emissions',
      'Transparent reporting of data sources and calculation methods',
      'Structured information basis for internal decision-making'
    ],
    technologies: [
      ...
      'Next.js API Routes',
      'e-conomic REST API v2',
      'Stripe API (Payments)',
      'OAuth 2.0 Authentication'
    ],
    link: 'https://klimaspor.dk',
  ...
  cherryplumpi: {
    title: 'CherryPlum Pi - Mini Computer Landing Page',
    image: 'images/cherryplum.png',
    tags: ['HTML5', 'CSS3', 'JavaScript', 'Three.js', 'GSAP', 'Concept Design'],
    description: 'A high-end landing page concept for CherryPlum Pi, a fictional next-generation mini computer similar to Raspberry Pi. Built to showcase what a modern hardware product website could look like with cutting-edge web technologies and animations.',
    features: [
    ...
    link: 'https://ddave82.github.io/CherryPlumPi/',
    linkText: 'View Live Demo'
  }
};
