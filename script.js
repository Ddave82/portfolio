...
const projectData = {
  ethicore: {
    ...
    link: 'https://github.com/Ddave82/ETHICORE-Concept-Website',
    linkText: 'View on GitHub'
  },
  froehlichundbunt: {
    title: 'Fröhlich und Bunt - Creative Coaching',
    image: 'images/froehlichundbunt.png',
    tags: ['WordPress', 'Divi Builder', 'Custom Plugin', 'PHP', 'AzuraCast'],
    description: 'A vibrant WordPress website for a creative coaching business, built with Divi Builder and enhanced with custom development. Features a self-developed WordPress plugin, extensive custom CSS, and a self-hosted web radio station powered by AzuraCast.',
    features: [
      'Custom WordPress plugin development in PHP',
      'Self-hosted web radio with AzuraCast integration',
      'Divi Builder customization and optimization',
      'Advanced custom CSS for unique styling',
      'Responsive design across all devices',
      'Custom post types and taxonomies',
      'Optimized page loading and performance',
      'Integration of booking and contact systems',
